...
export interface SharedClientState {
     ...
     */
    trackMutationResult(batchId: BatchId, state: 'acknowledged' | 'rejected', error?: FirestoreError): void;
    /**
     ...
     */
    trackQueryUpdate(targetId: TargetId, state: QueryTargetState, error?: FirestoreError): void;
    /**
...
export declare class QueryTargetMetadata {
    ...
    readonly error: FirestoreError;
    constructor(targetId: TargetId, lastUpdateTime: Date, state: QueryTargetState, error?: FirestoreError);
    /**

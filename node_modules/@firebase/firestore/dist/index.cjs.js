    ...
    IndexedDbPersistence.prototype.maybeGarbageCollectMultiClientState = function (txn) {
        ...
        if (!this.isWithinAge(this.lastGarbageCollectionTime, CLIENT_STATE_GARBAGE_COLLECTION_THRESHOLD_MS)) {
            ...
            return clientMetadataStore(txn)
                ...
                inactiveClients = existingClients.filter(function (client) { return activeClients.indexOf(client) === -1; });
            })
                .next(function () {
                ...
                // `lastProcessedDocumentChangeId`.
                activeClients = activeClients.filter(function (client) { return client.clientId !== _this.clientId; });
                if (activeClients.length > 0) {
                    var processedChangeIds = activeClients.map(function (client) { return client.lastProcessedDocumentChangeId || 0; });
...
var WebStorageSharedClientState = /** @class */ (function () {
    ...
    WebStorageSharedClientState.prototype.persistQueryTargetState = function (targetId, state, error$$1) {
        ...
        /* lastUpdateTime= */ new Date(), state, error$$1);
